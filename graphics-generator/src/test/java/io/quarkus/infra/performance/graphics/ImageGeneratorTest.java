...
import io.quarkus.infra.performance.graphics.model.UnknownFramework;
...
class ImageGeneratorTest {
    ...
    public void setup() throws IOException {
        ...
        if (Files.exists(targetDir) && Files.isDirectory(targetDir)) {
            ...
            addDatapoint(data, KnownFramework.QUARKUS3_JVM, THROUGHPUT);
            addDatapoint(data, KnownFramework.SPRING3_JVM, 267.87);
            addDatapoint(data, new UnknownFramework("unknown-test-framework"), 123.45);
            addConfig(data);
